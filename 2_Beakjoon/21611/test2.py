...
class Solution:
    ...
    def padding(self):
        if len(self.marble_list) > self.N * self.N:
            ...
            self.marble_list.extend(
                [0] * (self.N * self.N - len(self.marble_list))
            )
    ...
    def start_magic(self, attack_direction, attack_distance):
        # 구슬 공격
        # print("before attack", self.marble_list)
        ...
        # print("attack", self.marble_list)
        self.padding()
        # 4개이상 구슬 폭발
        self.marble_list = self.bomb(self.marble_list)
        # print("after bomb marble", self.marble_list)
        # 구슬 분화
        self.padding()
        ...
        # print("after extend", self.marble_list)
        self.padding()
